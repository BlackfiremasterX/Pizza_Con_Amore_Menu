...
import com.example.pizza_con_amore.data.COFFEE
import com.example.pizza_con_amore.data.coffeeArrayList
import com.example.pizza_con_amore.data.getCoffeeRef
import com.example.pizza_con_amore.data.getTeaRef
import com.example.pizza_con_amore.data.livedata
import com.example.pizza_con_amore.data.teaArrayList
...
import com.example.pizza_con_amore.data.firebase.adapter.HotDrinksAdapter
...
open class HotDrinksFragment : HomeFragment() {
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            tea_adapter = HotDrinksAdapter(teaArrayList, requireContext())
            coffee_adapter = HotDrinksAdapter(coffeeArrayList, requireContext())
